...
func save_data(var data : Dictionary, var profile : String = "save", var typefile : String = ".bea"):
	
	
	if profile == "":
		profile = "save"
	var thefile = File.new()
	thefile.open(res_user + "/" + profile + typefile, File.WRITE)
...
func edit_data(var profile : String = "save", var typefile : String = ".bea"):
	...
	if profile == "":
		profile = "save"
	var path = str(res_user + "/" + profile + typefile)
